...
class Doc
{
    ...
    public function getInfo($class, $action)
    {
        ...
        if($class && class_exists($class)){
            ...
            $class_doc['param_data'] = isset($class_doc['param_data']) ? $class_doc['param_data'] : [];
            if($reflection->hasMethod($action)) {
                ...
                $action_doc['param_data'] = isset($action_doc['param_data']) ? array_merge($class_doc['param_data'], $action_doc['param_data']) : $class_doc['param_data'];
            }
        }
        return $action_doc;
    }
